 ...
 * Modify History : Just Created.
 ------------------------------------------------------------*/
public class AffCreditCardExcelGenerator extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> objExcelMap, HSSFWorkbook workbook, HttpServletRequest req, HttpServletResponse res) throws Exception {
        ...
        try {
            ...
            if(objReqMap.get("EXCEL_TYPE").equals("EXCEL"))
            {
            	...
            	cell.setCellValue(CommonMessageDic.getMessage("IMS_BIM_BM_0374"));
            	cell.setCellStyle(cellCenterStyle);
            	cell = menuRow.createCell(7);
            	cell.setCellValue(CommonMessageDic.getMessage("IMS_BIM_BM_0382"));
            	cell.setCellStyle(cellCenterStyle);
            	cell = menuRow.createCell(8);
            	cell.setCellValue(CommonMessageDic.getMessage("IMS_BIM_BM_0331"));
            	cell.setCellStyle(cellCenterStyle);
            	cell = menuRow.createCell(9);
            	cell.setCellValue(CommonMessageDic.getMessage("IMS_BIM_BM_0383"));
            	cell.setCellStyle(cellCenterStyle);
            	cell = menuRow.createCell(10);
            	cell.setCellValue(CommonMessageDic.getMessage("IMS_BIM_BM_0375"));
            	cell.setCellStyle(cellCenterStyle);
            ...
            if (objExcelData.isEmpty()){
                ...
                for(Map<String, Object> objMap : objExcelData) {                    
                    ...
                    {                            
                    	cell = menuRow.createCell(0);
                    	cell.setCellValue(objMap.get( "NO" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(1);
                    	...
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(4);
                    	cell.setCellValue(CommonMessageDic.getMessage(objMap.get( "NOINT_NM" ).toString()));
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(5);
                    	cell.setCellValue(objMap.get( "MEMO" )==null ? "" : objMap.get( "MEMO" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(6);
                    	cell.setCellValue("D+"+objMap.get( "DPST_CYCLE" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(7);
                    	cell.setCellValue(objMap.get( "POINT_NM" )==null?"" : CommonMessageDic.getMessage(objMap.get( "POINT_NM" ).toString()));
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(8);
                    	cell.setCellValue(objMap.get( "CP_FEE" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(9);
                    	cell.setCellValue(objMap.get( "AUTH_TYPE_NM" )==null?"":objMap.get( "AUTH_TYPE_NM" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(10);
                    	cell.setCellValue(CommonMessageDic.getMessage(objMap.get("LIMIT_DIV_NM").toString()));  
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(11);
                    	cell.setCellValue(objMap.get( "MB_LMT" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    }
                    currentRow++;
                }
