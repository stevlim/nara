 ...
 * Modify History : Just Created.
 ------------------------------------------------------------*/
@Controller
@RequestMapping(value="/baseInfoMgmt/keyInfoMgmt")
public class KeyInfoMgmtController {
     ...
     * Modify History : Just Created.
     ----------------------------------------------------*/
    @RequestMapping(value = "/keyInfoMgmt.do")
    public String baseInfoMgmt(HttpServletRequest request, Model model, CommonMap commonMap) throws Exception {
        ...
        model.addAttribute("MENU_SUBMENU_TITLE", CommonMessageDic.getMessage("IMS_MENU_SUB_0155S"));
        ...
        return "/baseInfoMgmt/baseInfoMgmt/keyInfoMgmt";
    }
    //기본정보조회
