 ...
 * Modify History : Just Created.
 ------------------------------------------------------------*/
public class BaseInfoListExcelGenerator extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> objExcelMap, HSSFWorkbook workbook, HttpServletRequest req, HttpServletResponse res) throws Exception {
        ...
        try {
            ...
            if(objReqMap.get("EXCEL_TYPE").equals("EXCEL"))
            {
            	...
            	cell.setCellValue(CommonMessageDic.getMessage("IMS_BIM_MM_0006"));
            	cell.setCellStyle(cellCenterStyle);
            	cell = menuRow.createCell(2);
            	cell.setCellValue(CommonMessageDic.getMessage("IMS_BIM_MM_0054"));
            	cell.setCellStyle(cellCenterStyle);
            	cell = menuRow.createCell(3);
            	cell.setCellValue(CommonMessageDic.getMessage("IMS_BIM_MM_0051"));
            	cell.setCellStyle(cellCenterStyle);
            	cell = menuRow.createCell(4);
            	cell.setCellValue(CommonMessageDic.getMessage("DDLB_0137"));
            	cell.setCellStyle(cellCenterStyle);
            	cell = menuRow.createCell(5);
            	cell.setCellValue(CommonMessageDic.getMessage("DDLB_0138"));
            	cell.setCellStyle(cellCenterStyle);
            	cell = menuRow.createCell(6);
            	cell.setCellValue(CommonMessageDic.getMessage("DDLB_0139"));
            	cell.setCellStyle(cellCenterStyle);
            	cell = menuRow.createCell(7);
            	cell.setCellValue(CommonMessageDic.getMessage("IMS_BIM_MM_0008"));
            	cell.setCellStyle(cellCenterStyle);
            ...
            if (objExcelData.isEmpty()){
                ...
                for(Map<String, Object> objMap : objExcelData) {                    
                    ...
                    {                            
                    	...
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(7);
                    	cell.setCellValue(objMap.get( "REG_DNT" )==null?"":objMap.get( "REG_DNT" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    }
                    currentRow++;
                }
