package egov.linkpay.ims.sampleSubMgmt.dao;
...
/**------------------------------------------------------------
 * Package Name   : egov.linkpay.ims.sampleSubMgmt.dao
 * File Name      : SampleSubMgmtDAO.java
 * Description    : SampleSubMgmtDAO
 * Author         : st.lim, 2019. 02. 18.
 * Modify History : Just Created.
 ------------------------------------------------------------*/
@Repository("sampleSubMgmtDAO")
public class SampleSubMgmtDAO extends BaseDAO {
