 ...
 * Modify History : Just Created.
 ------------------------------------------------------------*/
public class CardInfoListExcelGenerator_back extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> objExcelMap, HSSFWorkbook workbook, HttpServletRequest req, HttpServletResponse res) throws Exception {
        ...
        try {
            ...
            if(objReqMap.get("EXCEL_TYPE").equals("EXCEL"))
            {
            	...
            	cell.setCellValue(CommonMessageDic.getMessage("IMS_BIM_BM_0152"));
            	cell.setCellStyle(cellCenterStyle);
            	cell = menuRow.createCell(5);
            	cell.setCellValue(CommonMessageDic.getMessage("IMS_BIM_BM_0153"));
            	cell.setCellStyle(cellCenterStyle);
            }
            ...
            if (objExcelData.isEmpty()){
                ...
                for(Map<String, Object> objMap : objExcelData) {                    
                    ...
                    {                            
                    	...
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(3);
                    	cell.setCellValue(objMap.get( "NON_INTEREST_NM" )==null?"":objMap.get( "NON_INTEREST_NM" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(4);
                    	cell.setCellValue(objMap.get( "APPCNT" )==null?"":objMap.get( "APPCNT" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(5);
                    	cell.setCellValue(objMap.get( "APPAMT" )==null?"":objMap.get( "APPAMT" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    }
                    currentRow++;
                }
