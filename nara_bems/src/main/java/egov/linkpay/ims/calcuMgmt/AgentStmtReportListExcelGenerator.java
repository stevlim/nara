 ...
 * Modify History : Just Created.
 ------------------------------------------------------------*/
public class AgentStmtReportListExcelGenerator extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> objExcelMap, HSSFWorkbook workbook, HttpServletRequest req, HttpServletResponse res) throws Exception {
        ...
        try {
            ...
            if(objReqMap.get("EXCEL_TYPE").equals("EXCEL"))
            {
            	...
            	sheet. addMergedRegion (new Region(( int) 0 , ( short )17 , ( int) 0, (short )24 ));
            	
            	sheet. addMergedRegion (new Region(( int) 0 , ( short )25 , ( int) 1, (short )25 ));
            	
            	cell.setCellValue(CommonMessageDic.getMessage("IMS_BIM_BM_0630"));
            	...
            	cell.setCellValue(CommonMessageDic.getMessage("IMS_BIM_BM_0636"));
            	cell.setCellStyle(cellCenterStyle);
            	...
            	cell.setCellValue(CommonMessageDic.getMessage("IMS_BIM_BM_0637"));
            	cell.setCellStyle(cellCenterStyle);
            ...
            if (objExcelData.isEmpty()){
                ...
                for(Map<String, Object> objMap : objExcelData) {                    
                    ...
                    {                            
                    	...
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(5);
                    	cell.setCellValue(objMap.get( "TRAN_AMT" )==null?"":objMap.get( "TRAN_AMT" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(6);
                    	cell.setCellValue(objMap.get( "SALES_FEE" )==null?"":objMap.get("SALES_FEE").toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(7);
                    	...
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(11);
                    	cell.setCellValue(objMap.get( "PAY_AMT_VAT" )==null?"":objMap.get( "PAY_AMT_VAT" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(12);
                    	...
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(15);
                    	cell.setCellValue(objMap.get( "CARD_FLAT_AMT" )==null?"":objMap.get( "CARD_FLAT_AMT" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(16);
                    	cell.setCellValue(objMap.get( "DPST_AMT" )==null?"":objMap.get( "DPST_AMT" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(17);
                    	cell.setCellValue(objMap.get( "CARRY_TRANS_AMT" )==null?"":objMap.get( "CARRY_TRANS_AMT" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(18);
                    	cell.setCellValue(objMap.get( "CARRY_FEE" )==null?"":objMap.get( "CARRY_FEE" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(19);
                    	cell.setCellValue(objMap.get( "CARRY_VAT" )==null?"":objMap.get( "CARRY_VAT" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(20);
                    	cell.setCellValue(objMap.get( "CARRY_PAY_AMT" )==null?"":objMap.get( "CARRY_PAY_AMT" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(21);
                    	cell.setCellValue(objMap.get( "CARRY_PAY_VAT" )==null?"":objMap.get( "CARRY_PAY_VAT" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(22);
                    	cell.setCellValue(objMap.get( "CARRY_RESR_AMT" )==null?"":objMap.get( "CARRY_RESR_AMT" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(23);
                    	cell.setCellValue(objMap.get( "CARRY_EXTRA_AMT" )==null?"":objMap.get( "CARRY_EXTRA_AMT" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(24);
                    	cell.setCellValue(objMap.get( "CARRY_DPST_AMT" )==null?"":objMap.get( "CARRY_DPST_AMT" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
                    	cell = menuRow.createCell(25);
                    	cell.setCellValue(objMap.get( "TOT_DPST_AMT" )==null?"":objMap.get( "TOT_DPST_AMT" ).toString());
                    	cell.setCellStyle(cellCenterStyle);
