...
$.jgrid.extend({
	...
	setPostData : function( newdata ) {
		...
		if ( typeof(newdata) === 'object' ) {
			...
			IONPay.Msg.fnAlert("Error: cannot add a non-object postData value. postData unchanged.");
		}
	},
	appendPostData : function( newdata ) { 
		...
		if ( typeof(newdata) === 'object' ) {
			...
			IONPay.Msg.fnAlert("Error: cannot append a non-object postData value. postData unchanged.");
		}
	},
