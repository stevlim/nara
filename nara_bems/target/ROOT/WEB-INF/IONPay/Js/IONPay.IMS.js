...
IONPay.Ajax = {
	...
	/**------------------------------------------------------------
	 * Function Name  : fnCoNoDupChkRequest
	 * Description    : Ajax Process
	 * Author         : lst, 2018. 08. 27.
	 * Modify History : Just Created.
	 ------------------------------------------------------------*/
	fnCoNoDupChkRequest: function(arrParameter, strCallUrl, strCallBack, isaSync) {
		var intErrCnt = 0;
	 ...
	 * Modify History : Just Created.
	 ------------------------------------------------------------*/
	fnMerApplyRequest: function(arrParameter, strCallUrl, strCallBack, isaSync) {
		var intErrCnt = 0;
		...
		$.ajax({
			...
			success :function(data){
				if(data.result == "y") {
					alert($("#merApplySuccessMsg").val());
				}else {
					alert($("#merApplyFailMsg").val());
				}
