...
function fnSetDDLB() {
    ...
    $("#frmSearch #ingStatus").html("<c:out value='${RM_STATUS}' escapeXml='false' />");
}
                            ...
                            <div class="grid-body no-border">
                                <form id="frmSearch" name="frmsearch">
                                    ...
                                    <div class="row form-row"  style="padding:0 0 10px 0;">
                                        <div class="col-md-3">
                                            <label class="form-label"><spring:message code='IMS_BIM_BM_0240'/></label> 
                                            <select id="ingStatus" name="ingStatus" class="select2 form-control">
                                            </select>
                                        </div>
                                      	<div class="col-md-3">
		                             ...
		                             <div class="row form-row" >
				                       <div class="col-md-2">
				                              <label class="form-label"><spring:message code='IMS_BIM_BM_0243'/></label> 
                                            ...
                                            <table id="" class="table"  style="width:100%">
                                            	<thead>
                                            		<tr> 
	                                                     ...
	                                                     <th>I D</th>
	                                                     <th colspan="2" ><spring:message code='IMS_BIM_BM_0245'/></th>
	                                                     <th><spring:message code='IMS_BIM_BM_0248'/></th>
	                                                     <th><spring:message code='IMS_BIM_BM_0250'/></th>
	                                                     <th><spring:message code='IMS_BIM_BM_0252'/></th>
	                                                     <th><spring:message code='IMS_BIM_BM_0254'/></th>
	                                                     <th><spring:message code='IMS_BIM_BM_0242'/></th>
	                                                     <th><spring:message code='IMS_BIM_BM_0257'/></th>
	                                                     <th><spring:message code='IMS_BIM_BM_0259'/></th> 
	                                                     <th rowspan="2"  class="th_verticleLine"><spring:message code='IMS_BIM_BM_0240'/></th>
	                                                     <th rowspan="2"  class="th_verticleLine"><spring:message code='IMS_BIM_BM_0137'/></th>
                                                 	</tr>
                                                 	<tr >
                                                 		 <th><spring:message code='IMS_BIM_BM_0244'/></th>
                                                 		 <th><spring:message code='IMS_BIM_BM_0246'/></th>
                                                 		 <th><spring:message code='IMS_BIM_BM_0247'/></th>
                                                 		 <th><spring:message code='IMS_BIM_BM_0249'/></th>
                                                 		 <th><spring:message code='IMS_BIM_BM_0251'/></th>
                                                 		 ...
                                                 		 <th><spring:message code='IMS_BIM_BM_0258'/></th>
	                                                   	 <th><spring:message code='IMS_BIM_BM_0260'/></th>
                                                 	</tr>
                                            	</thead>
